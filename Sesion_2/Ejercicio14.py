...
print(f'{"Salario actual:":<36} ${salario_actual:>12}')
print(f'{"Incremento (8%):":<36} ${incremento:>12}')
print(f'{"Descuento por servicios (2.5%):":<36} ${descuento_servicios:>12}')
print(f'{"Nuevo salario:":<36} ${nuevo_salario:>12}')
print("="*50)